...
def load_model_for_inference(config, num_classes, dataset, fold, seed) -> MambaClassificationModel:
    '''
    Loads the best saved model checkpoint for a given dataset, fold, and seed.
    '''
...
def test_model(model, test_loader, device):
    ...
    report = classification_report(all_labels, all_preds, target_names = ["LIE", "SIT", "STAND", "WALK"], output_dict = True)
