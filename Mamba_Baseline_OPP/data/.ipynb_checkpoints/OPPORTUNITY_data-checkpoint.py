...
def load_OPP_loco_data(training_files, validation_files, test_files, verbose = False) -> tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    '''
