...
def load_OPP_loco_data(training_files, validation_files, test_files, fold_id=1, verbose = False) -> tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    '''
...
# --------------------------------------------------
    ...
    #training_data_scaled.to_csv(f"OPP_training_scaled_fold{fold_id}.csv", index = False)
    #validation_data_scaled.to_csv(f"OPP_validation_scaled_fold{fold_id}.csv", index = False)
    #test_data_scaled.to_csv(f"OPP_test_scaled_fold{fold_id}.csv", index = False)
